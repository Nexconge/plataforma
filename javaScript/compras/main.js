import { API_URL, fetchOrdens, saveOrdem, deleteOrdem, updateOrdemStatus } from './api.js';
...
$$('.tab').forEach(t => t.addEventListener('click', () => { switchTab(t.dataset.tab); if (t.dataset.tab === 'historico') renderHistorico(); }));
...
$('#btn-salvar').addEventListener('click', async () => {
  ...
  await saveOrdem(method, url, payload);
  await loadCards();
  closeModal();
